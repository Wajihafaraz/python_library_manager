...
class BookCollection: #class ek blue print hota he object ko create karne ka object k andr data hota he ya methods hote hn
    ...
    def read_from_file(self):
        ...
        try:
            with open(self.storage_file,"r") as file:
                self.book_list=json.load(file)  #hold kra empty list
    ...
    def save_to_file(self):
        ...
        with open(self.storage_file, "w") as file:
            json.dump(self.book_list, file, indent= 4 )   #data ko json format k andr phnk rha
